    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'dent-all' );
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'dent-all' ) . '</strong>';
            }
        } //function
