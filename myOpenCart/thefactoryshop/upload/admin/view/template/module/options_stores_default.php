					...
					<div class="panel-container">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">
								<span data-toggle="tooltip" title="Lazy Load is delays loading of images in long Listing pages">Lazy Loader</span>
							</label>
							<div class="col-sm-10">
								<div class="btn-group btn-toggle" data-toggle="buttons">
									<label class="btn btn-default btn-sm <?php if(!isset($soconfig_general["lazy_loader"])) { $soconfig_general["lazy_loader"] = 1;} if ($soconfig_general["lazy_loader"] == 1): ?>btn-success active <?php endif; ?>">
										<input type="radio" name="soconfig_general[lazy_loader]" value="1" <?php if ($soconfig_general["lazy_loader"] == 1): ?> checked="checked"<?php endif; ?>>ON
									</label>
									<label class="btn btn-default btn-sm <?php if ($soconfig_general["lazy_loader"] == 0): ?>btn-success active <?php endif; ?>">
										<input type="radio" name="soconfig_general[lazy_loader]" value="0" <?php if ($soconfig_general["lazy_loader"] == 0): ?> checked="checked"<?php endif; ?>>OFF
									</label>
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">
								<span data-toggle="tooltip" title="Reveals animations when you scroll">Reveal Animations When Scrolling</span>
							</label>
							<div class="col-sm-10">
								<div class="btn-group btn-toggle" data-toggle="buttons">
						...
						<div class="col-sm-8" >
							...
							<div class="tab-content">
								...
								<div class="tab-pane <?php echo ($language['language_id'] == 1 ? 'active' : ''); ?>" id="language-welcome_message<?php echo $language['language_id']; ?>">
									<textarea name="soconfig_general[<?php echo $language['language_id']; ?>][welcome_message]" placeholder="Footer Social Block content" id="input-description-welcome_message<?php echo $language['language_id']; ?>-<?php echo $store['store_id']; ?>"><?php echo isset($soconfig_general[$language['language_id']]['welcome_message']) ? $soconfig_general[$language['language_id']]['welcome_message'] : ''; ?></textarea>
								</div>
								<?php endforeach; ?>
							</div>
