        ...
        <div class="extraslider-inner" data-effect="<?php echo $effect; ?>">
            ...
            ?>
                ...
                <div class="product-thumb transition">
                    ...
                    <div class="image <?php if(isset($soconfig_pages["secondimg"]) && $soconfig_pages["secondimg"] =='2' && isset($product['thumb2'])){ echo "second_img";} ?>">
                        <a class="block-image" href="<?php echo $product['href'];?>" target="<?php echo $item_link_target;?>">
                           <img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" class="img-responsive img_1" />
						   <?php  if(!empty($product['thumb2'])&& $soconfig_pages["secondimg"] =='2' && isset($product['thumb2'])) :?>
								<img src="<?php echo $product['thumb2']; ?>" alt="<?php echo $product['name']; ?>" class="img-responsive img_0" />
						  <?php endif;?>
