...
<div class="responsive so-megamenu megamenu-style-dev">
	...
	<?php if($ustawienia['disp_title_module'] && isset($head_name) && $head_name) { ?>
		<h3 class="title-menu"><i class="fa fa-list-ul"></i><?php echo $head_name; ?></h3>
	<?php } ?>
		...
		<div id="menuHeading">
			<div class="megamenuToogle-wrapper">
				<div class="megamenuToogle-pattern">
					<div class="container">
							<h3 class="title-menu"><i class="fa fa-list-ul"></i><?php echo $navigation_text; ?></h3>
					</div>
				</div>
			</div>
		</div>	
				...
				<div class="container">
					<ul class="megamenu">
						...
						echo "<li class='".$class."' ".$title."><p class='close-menu'></p>";						
							if(is_array($row['submenu']) && !empty($row['submenu']))
								echo "<a href='".$row['link']."' class='".$class_link."' ".$target."><strong>".$row['icon'].$row['name'][$lang_id].$row['description']."</strong> <span class='label'> ".$row['label_item']."</span> <b class='fa fa-caret-down' ></b> </a>";
							else
