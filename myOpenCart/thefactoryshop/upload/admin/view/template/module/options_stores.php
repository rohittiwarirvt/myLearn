				...
				<div class="so-panel">
					...
					<div class="panel-container">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php echo field_onOff('soconfig_general_store',$soconfig_general_store,'lazy_loader'); ?>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">
						...
						<div class="col-sm-8" >
							...
							<div class="tab-content">
								...
								<div class="tab-pane <?php echo ($language['language_id'] == 1 ? 'active' : ''); ?>" id="language-welcome_message<?php echo $language['language_id']; ?><?php echo $store["store_id"]; ?>">
									<textarea name="soconfig_general_store[<?php echo $language['language_id']; ?>][<?php echo $store["store_id"]; ?>][welcome_message]" placeholder="Footer Social Block content" id="input-description-welcome_message<?php echo $language['language_id']; ?>-<?php echo $store['store_id']; ?>">
									<?php echo isset($soconfig_general_store[$language['language_id']][$store["store_id"]]['welcome_message']) ? $soconfig_general_store[$language['language_id']][$store["store_id"]]['welcome_message'] : ''; ?>
									</textarea>
								</div>
								<?php endforeach; ?>
							</div>
