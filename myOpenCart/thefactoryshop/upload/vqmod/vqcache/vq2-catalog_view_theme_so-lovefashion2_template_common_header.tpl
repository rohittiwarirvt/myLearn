				...
				<div class="row">
					...
					<div class="header-top-right collapsed-block col-xs-6 compact-hidden">
						...
						<ul class="top-link list-inline">
							...
							<?php } else { ?>
							<li class="account" id="my_account"><span class="btn btn-xs dropdown-toggle "> <span><?php echo $text_account; ?></span>&nbsp;<span class="fa fa-angle-down"></span></span>
								<ul class="dropdown-menu ">
									<li><a href="<?php echo $register; ?>"><i class="fa fa-user"></i> <?php echo $text_login; ?></a></li>
									<li><a href="<?php echo $login; ?>"><i class="fa fa-pencil-square-o"></i> <?php echo $text_register; ?></a></li>
								</ul>
							</li>
							<?php } ?>
			...
			<div class="container">
			   ...
			   <?php if ($header_type == 'center') { ?>
				 <?php 
					...
					<div class="navbar-logo col-lg-3 col-sm-12 col-xs-12 text-center">
						<?php if ($logo) { ?>
			   ...
			   <!--end header variant center-->
				    ...
				    <?php } else { ?>
				    <!-- Logo -->
				    <div class="navbar-logo col-lg-3 col-sm-12 col-xs-12">
					   <?php if ($logo) { ?>
					   <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a>
					   <?php } else { ?>
					   <h1><a href="<?php echo $home; ?>"><?php echo $name; ?></a></h1>
					   <?php } ?>
						 ...
						 <!-- Search -->
						<div class="menu-res col-lg-6 col-md-9 col-sm-6 col-xs-2">
						<?php echo $content_menu;?>
						</div>
						 <!-- //end Search -->
				    <?php }  ?>
				    ...
				    <!-- Secondary menu -->
				    <div class="cart-wishlish-compare pull-right col-lg-3 col-md-3 col-sm-12 col-xs-12">
					   <!--Cart desktop-->
					   <?php
