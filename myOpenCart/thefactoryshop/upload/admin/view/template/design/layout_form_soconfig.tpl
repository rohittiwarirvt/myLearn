              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <?php if ($name == 'Footer' || $name == 'footer') { ?> 
                 ...
                 <?php } else { ?>   
                    ...
                    <option value="content_block7" selected="selected">Content Block 7</option>
                    <?php } else { ?>
                    <option value="content_block7">Content Block 7</option>
                    <?php } ?>
					<?php if ($layout_module['position'] == 'content_block8') { ?>
                    <option value="content_block8" selected="selected">Content Block 8</option>
                    <?php } else { ?>
                    <option value="content_block8">Content Block 8</option>
                    <?php } ?>
					<?php } ?>
...
function addModule() {
	...
	html += '    <option value="content_block7">Content Block 7</option>';
	html += '    <option value="content_block8">Content Block 8</option>';
