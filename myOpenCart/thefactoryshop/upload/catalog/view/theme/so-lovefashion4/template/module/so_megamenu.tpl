...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(itemver <= $( ".vertical ul.megamenu >li" ).length)
			$('.vertical ul.megamenu').append('<li class="loadmore"><i class="fa fa-align-justify"></i><span class="more-view"><?php echo $more_text;?></span></li>');
		...
		$(".megamenu .loadmore").click(function(){
			if($(this).hasClass('open')){
				...
				$('.loadmore').html('<i class="fa fa-align-justify"></i><span class="more-view"><?php echo $more_text;?></span>');
			}else{
				$('ul.megamenu li.item-vertical').each(function(i){
						if(i>show_itemver){
								$(this).slideDown(200);
				...
				$(this).addClass('open');
				$('.loadmore').html('<i class="fa fa-times"></i><span class="more-view"><?php echo $close_text;?></span>');
			}
		});
	});
</script>
