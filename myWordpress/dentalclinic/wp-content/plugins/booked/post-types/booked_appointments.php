	...
	class booked_appointments_post_type {
		...
		public function create_post_type() {
			...
			$labels = array(
				...
				'search_items'               => __( 'Search Custom Calendars', 'booked' ),
				'popular_items'              => __( 'Popular Custom Calendars', 'booked' ),
				'all_items'                  => __( 'All Custom Calendars', 'booked' ),
				'parent_item'                => null,
				'parent_item_colon'          => null,
				'edit_item'                  => __( 'Edit Custom Calendar', 'booked' ),
				'update_item'                => __( 'Update Custom Calendar', 'booked' ),
				'add_new_item'               => __( 'Add New Custom Calendar', 'booked' ),
				'new_item_name'              => __( 'New Custom Calendar Name', 'booked' ),
				'separate_items_with_commas' => __( 'Separate custom calendars with commas', 'booked' ),
				'add_or_remove_items'        => __( 'Add or remove custom calendars', 'booked' ),
				'choose_from_most_used'      => __( 'Choose from the most used custom calendars', 'booked' ),
				'not_found'                  => __( 'No custom calendars found.', 'booked' ),
				'menu_name'                  => __( 'Custom Calendars', 'booked' ),
			);
