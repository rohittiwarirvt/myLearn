    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if(isset($_POST['button-save'])){
				...
				$moduleid_new= $this->model_module_so_megamenu->getModuleId(); // Get module id
				$module_id = '';
				...
				if (isset($this->request->post['import_module']) && $this->request->post['import_module']) {
					...
					$this->model_module_so_megamenu->duplicateModule($module_id,$import_module);
				}					
                $this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('module/so_megamenu', 'module_id='.$module_id.'&token=' . $this->session->data['token'], 'SSL'));
			}
        }
        ...
        {
            $this->model_module_so_megamenu->duplicateMenu($_GET['duplicate']);
            $this->response->redirect(HTTPS_SERVER . 'index.php?route=module/so_megamenu&token=' . $this->session->data['token'].'&action=create&module_id='.$this->request->get['module_id']);
        }
