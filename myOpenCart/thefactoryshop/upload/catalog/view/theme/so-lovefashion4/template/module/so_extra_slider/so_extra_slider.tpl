						...
						<div class="item-wrap-inner">
								<div class="item-image">
									<div class="item-img-info">
										...
										<a class="quickview iframe-link hidden-md hidden-sm hidden-xs" data-fancybox-type="iframe"  href="<?php echo $our_url->link('product/quickview','product_id='.$product['product_id']);?>"></a>
