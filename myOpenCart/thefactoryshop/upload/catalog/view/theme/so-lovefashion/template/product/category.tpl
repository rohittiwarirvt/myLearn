				...
				<div class="left-block">
					<div class="product-image-container <?php echo $lazyload_text?> <?php if($secondimg =='2' && isset($product['thumb2'])){ echo "second_img";} ?> ">
						...
						<?php if (!isset($quick_status) || $quick_status != 0) : ?>
								...
								<a class="quickview iframe-link visible-lg" data-toggle="tooltip" title="<?php echo $quick_view_text; ?>"  data-fancybox-type="iframe"  href="<?php echo $our_url->link('product/quickview','product_id='.$product['product_id']);?>"></a>
						<?php endif; ?>
						<!--countdown box-->
