...
<?php // Begin General CSS ----- ?>
	...
	<link href="catalog/view/javascript/anijs/anicollection.css" rel="stylesheet" />
	<?php } ?>
...
?>
		...
		<style type="text/css">
			<?php 
			if ($soconfig_fonts[$font_array."_status"] =='google') echo html_entity_decode($soconfig_fonts["selector_".$font_array]).'{font-family:'. $soconfig_fonts["family_".$font_array].'}';
...
<?php // Begin Themes Scripts ----?>
	...
	<?php if (!isset($soconfig_general["lazy_loader"]) || $soconfig_general["lazy_loader"] != 0) { ?>
	<script type="text/javascript" src="catalog/view/theme/<?php echo $config->get('config_template'); ?>/js/jquery.unveil.js"></script>
	<?php } ?>
	
	<?php if (!isset($soconfig_general["scroll_animation"]) || $soconfig_general["scroll_animation"] != 0) { ?>
	<script type="text/javascript" src="catalog/view/javascript/anijs/anijs-min.js"></script>
	<script type="text/javascript" src="catalog/view/javascript/anijs/anijs-helper-scrollreveal.js"></script>
	<?php } ?>
...
<div id="wrapper" class="<?php echo $cls_wrapper; ?>">
	...
	<header id="header" class=" variant<?php echo $header_type; ?>">
				...
				<div class="row">
					<div class="header-top-left form-inline col-sm-6 compact-hidden">
						...
						<?php if($soconfig_general["lang_status"]):?>
							<div class="curr"><?php echo $currency; ?></div>
					...
					<div class="header-top-right collapsed-block col-xs-6 compact-hidden">
						...
						<ul class="top-link list-inline">
							<?php if ($logged) { ?>
							<li class="account" id="my_account"><span class="btn btn-xs dropdown-toggle" data-toggle="dropdown"> <span><?php echo $text_account; ?></span><?php if ($logged) { ?> <span class="fa fa-angle-down"></span><?php }?></span>
							...
							<?php } else { ?>
							<li class="account" id="my_account"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="btn btn-xs dropdown-toggle "> <span><?php echo $text_account; ?></span></a></li>
							<?php } ?>
			...
			<div class="container">
			   ...
			   <?php if ($header_type == 'center') { ?>
				 <?php 
					...
					<div class="navbar-logo col-md-3 col-sm-12 col-xs-12 text-center">
						<?php if ($logo) { ?>
			   ...
			   <!--end header variant center-->
				    ...
				    <div class="cart-wishlish-compare pull-right col-md-4 col-sm-12 col-xs-12">
						<ul class="wishlish-compare">
							<?php if($soconfig_general["wishlist_status"]):?><li class="wishlist"><i class="fa fa-heart"></i><a href="<?php echo $wishlist; ?>" id="wishlist-total" class="top-link-wishlist" title="<?php echo $text_wishlist; ?>"><span><?php echo $text_wishlist; ?></span></a></li><?php endif; ?>
							<li class="compare"><i class="fa fa-book"></i> <a href="<?php echo $compare; ?>" id="compare-total" class="top-link-compare" title="<?php echo $text_compare; ?>"><span ><?php echo $text_compare; ?></span></a></li>
		...
		<section class="header-bottom">
			...
			<div class="row">
				<!-- Main menu -->
				<div class="header-bottom-left col-lg-10 col-md-9 col-xs-5">
				...
				<div class= "header-bottom-right col-lg-2 col-md-3 col-xs-7">
					<?php if ($logged) { ?>
					<ul class="log-reg login-statut">
						<li class="welcome">
							<?php
							$text_welcome = trim( $welcome_message);
							$arr = explode(" ", $text_welcome);
							echo $arr[0]." ".$arr[1];
...
<?php echo $quicksignup; ?>
							<span class="btn-login"> <?php echo $text_login; ?></span>
						</li>
						<li class="quick-register">
							<div><a href="<?php echo $register;  ?>" class="btn-register"><?php echo $text_register; ?></a></div>
						</li>
		...
		<div class="navbar-switcher-container hidden-md">
