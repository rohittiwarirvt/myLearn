...
<div id="content">
							...
							<div class="tab-pane">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="content_option"> <!--Content Option -->
										...
										<div class="tab-content">
											<?php foreach ($languages as $language) { ?>
											<div class="tab-pane" id="content_<?php echo $language['language_id']; ?>"> <!--content -->
												...
												<div id="sign-up-option">
													<div class="form-group" id="input-newsletter_promo"> <!--newsletter promo -->
									...
									<!-- ----------------------------------------------------------------------- -->
									<div class="tab-pane" id="newsletter_subscribers_option"> <!--newsletter subscribers option -->
										<div id="history"></div>
									</div>
									<!-- ----------------------------------------------------------------------- -->
									<div class="tab-pane" id="html_Email_template"> <!--Content Option -->
										...
										<div class="form-group"> <!--Content Email -->
											...
											<div class="col-sm-10">
												<div class="col-sm-10">
													<textarea name="content_email" placeholder="<?php echo $entry_content_email; ?>" id="input-content_email"><?php echo $module['content_email']; ?></textarea>
												</div>
											</div>
										</div>
									</div>
	...
	<script type="text/javascript"><!--
		<?php foreach ($languages as $language) { ?>
			$('#input-description<?php echo $language['language_id']; ?>').summernote({height: 400});
		<?php } ?>
		$('#input-content_email').summernote({height: 400});
		...
		$('#history').load('index.php?route=module/so_newletter_custom_popup/history&token=<?php echo $token; ?>');
		function mailing_all() {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/mailing_all&token=<?php echo $token; ?>&module_id=<?php echo $selectedid; ?>',
				dataType: 'json',
		...
		function mailing_selected(subscribe_id) {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/mailing_selected&token=<?php echo $token; ?>&module_id=<?php echo $selectedid; ?>&subscribe_id=' + subscribe_id,
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['error']) {
		...
		function mailing_all_selected() {
			$.ajax({
				type: 'post',
				url:  'index.php?route=module/so_newletter_custom_popup/mailing_all_selected&token=<?php echo $token; ?>&module_id=<?php echo $selectedid; ?>',
		...
		function mailing_all_not_notified() {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/mailing_all_not_notified&token=<?php echo $token; ?>&module_id=<?php echo $selectedid; ?>',
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['error']) {
		...
		function mailing_all_approved() {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/mailing_all_approved&token=<?php echo $token; ?>&module_id=<?php echo $selectedid; ?>',
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['error']) {
		...
		function revert_yet_send() {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/revert_yet_send&token=<?php echo $token; ?>',
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['success']) {
		...
		function approve_selected(subscribe_id) {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/approve_selected&token=<?php echo $token; ?>&subscribe_id=' + subscribe_id,
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['success']) {
		...
		function approve_all_selected() {
			$.ajax({
				type: 'post',
				url:  'index.php?route=module/so_newletter_custom_popup/approve_all_selected&token=<?php echo $token; ?>',
				data: $('#history input[type=\'checkbox\']:checked'),
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
		...
		function approve_all_not_approved() {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/approve_all_not_approved&token=<?php echo $token; ?>',
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['error']) {
		...
		function delete_selected(subscribe_id) {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/delete_selected&token=<?php echo $token; ?>&subscribe_id=' + subscribe_id,
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['success']) {
		...
		function delete_all() {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/delete_all&token=<?php echo $token; ?>',
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['error']) {
		...
		function delete_all_selected() {
			$.ajax({
				type: 'post',
				url:  'index.php?route=module/so_newletter_custom_popup/delete_all_selected&token=<?php echo $token; ?>',
				data: $('#history input[type=\'checkbox\']:checked'),
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
		...
		function delete_all_not_approved() {
			$.ajax({
				type: 'get',
				url:  'index.php?route=module/so_newletter_custom_popup/delete_all_not_approved&token=<?php echo $token; ?>',
				dataType: 'json',
				success: function(json) {
					$('.alert, .text-danger').remove();
					if (json['error']) {
