        ...
        <div class="extraslider-inner" data-effect="<?php echo $effect; ?>">
            ...
            ?>
                ...
                <div class="product-thumb transition">
                    ...
                    <div class="image <?php if($product_image_num ==2){ echo "second_img";} ?>">
						<?php if ($product['special'] && $display_sale) : ?>
							<span class="label label-sale-mod"><?php echo $text_sale; ?></span>
						<?php endif; ?>
						<?php if ($product['productNew'] && $display_new) : ?>
							<span class="label label-new-mod"><?php echo $text_new; ?></span>
						<?php endif; ?>
						<a href="<?php echo $product['href'];?>" target="<?php echo $item_link_target;?>" class="block-image">
							<?php if($product_image_num ==2){?>
									<img src="<?php echo $product['thumb']?>" class="img-responsive img_1" alt="<?php echo $product['nameFull'] ?>">
									<img src="<?php echo $product['thumb2']?>" class="img-responsive img_0" alt="<?php echo $product['nameFull'] ?>">
							
							<?php }else{?>
								<img src="<?php echo $product['thumb']?>" alt="<?php echo $product['nameFull'] ?>" class="img-responsive img_1">
							<?php }?>
						</a>
						<div class="item-time">
						...
						<a class="quickview iframe-link hidden-md hidden-sm hidden-xs" data-fancybox-type="iframe"  href="<?php echo $our_url->link('product/quickview','product_id='.$product['product_id']);?>"><?php echo (isset($quick_view_text) ? $quick_view_text : 'Quick View'); ?></a>
