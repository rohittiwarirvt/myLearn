  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="page-title"><h1><?php echo $heading_title; ?></h1></div>
            ...
            <?php } ?>
				<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDHtKBWGyrkaZXUJGFiyKwGKZezT2SB-AY"></script>
               <?php if ($geocode) { ?>
				<script>
                    function initialize() {
      ...
      <div class="info-contact">
        ...
        <div class="col-lg-8 col-sm-8 col-xs-12 contact-form">
           <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
              <legend><h3 style="color: #666;"><?php echo $text_contact; ?></h3></legend>
