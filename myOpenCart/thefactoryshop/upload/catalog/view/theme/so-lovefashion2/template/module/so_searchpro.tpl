<div id="sosearchpro" class="sosearchpro-wrapper <?php echo $additional_class; ?> collapsed-block">
	<h5 class="tabBlockTitle dropdow-search visible-sm visible-xs"><a class="expander " href="#TabBlock-search"><i class="fa fa-search"></i></a></h5>
	...
	<div id="search<?php echo $module ?>" class="search input-group">
	    ...
	    <input class="autosearch-input form-control" type="text" value="" size="50" autocomplete="off" placeholder="<?php echo $text_search ;?>" name="search">
			<button type="submit" class="button-search btn btn-default btn-lg" name="submit_search"><?php echo $btn_search ;?></button>
		</div>
	</div>
