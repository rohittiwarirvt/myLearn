    ...
    <div id="redux-footer">
        ...
        <div class="redux-action_bar">
            ...
            <?php if ( false === $this->parent->args['hide_save'] ) : ?>
                <?php submit_button( __( 'Save Changes', 'dent-all' ), 'primary', 'redux_save', false ); ?>
            <?php endif; ?>

            <?php if ( false === $this->parent->args['hide_reset'] ) : ?>
                <?php submit_button( __( 'Reset Section', 'dent-all' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section' ) ); ?>
                <?php submit_button( __( 'Reset All', 'dent-all' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults' ) ); ?>
            <?php endif; ?>

        </div>

        <div class="redux-ajax-loading" alt="<?php _e( 'Working...', 'dent-all' ) ?>">&nbsp;</div>
        <div class="clear"></div>
