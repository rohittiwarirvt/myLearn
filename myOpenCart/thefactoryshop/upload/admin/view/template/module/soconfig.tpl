...
$(document).ready(function(){
    ...
    $('#input-description-welcome_message<?php echo $language['language_id']; ?>-0').summernote({height: 150});
    <?php endforeach; ?>
    ...
    $('#input-description-welcome_message<?php echo $language['language_id']; ?>-<?php echo $store['store_id']; ?>').summernote({height: 150});
    <?php endforeach; ?>
